...
(function () {
  ...
  const translations = {
    en: {
      ...
      opt_evt_select: 'Select celebration...',
      opt_evt_quince: 'Quinceañera (15th Birthday)',
      opt_evt_wedding: 'Wedding',
      opt_evt_graduation: 'Graduation',
      opt_evt_birthday: 'Milestone Birthday',
      opt_evt_babyshower: 'Baby Shower / Gender Reveal',
      opt_evt_baptism: 'Baptism / First Communion',
      opt_evt_anniversary: 'Anniversary',
      opt_evt_other: 'Other Celebration',
      ...
      step2_card5_title: 'Photos & Images',
      step2_card5_sub: 'No need to upload now — send easily after submitting.',
      lbl_photos_after_submit_title: 'Photos: Send After Submitting Your Order',
      lbl_photos_after_submit_desc: 'To avoid file upload limits or losing your typed details, complete and submit your event information first. Right on the confirmation screen, you will get a direct 1-tap link to send your photos via WhatsApp or Facebook!',
      lbl_cloud_link: 'Or Share a Cloud Album Link (Optional — Google Photos, iCloud, Drive, Dropbox)',
      hint_cloud_link: 'Have your photos in Google Drive, Google Photos, or iCloud? You can paste the link here.',
      ...
      step3_sub: 'We have received your celebration details. Your order is secured!',
      step3_badge_next: 'Next Step',
      step3_photos_action_title: 'Send Your Celebration Photos',
      step3_photos_action_desc: 'Now send your favorite photos (cover photo, court of honor, and gallery) directly to us via WhatsApp or Facebook so our design team can begin your preview:',
      btn_send_photos_wa_order: 'Send Photos on WhatsApp (815) 242-7556',
      btn_send_photos_fb: 'Or Send on Facebook',
      btn_send_photos_ig: 'Or Send on Instagram',
    ...
    es: {
      ...
      opt_evt_select: 'Selecciona una celebración...',
      opt_evt_quince: 'Quinceañera',
      opt_evt_wedding: 'Boda',
      opt_evt_graduation: 'Graduación',
      opt_evt_birthday: 'Cumpleaños Especial',
      opt_evt_babyshower: 'Baby Shower / Revelación de Género',
      opt_evt_baptism: 'Bautizo / Primera Comunión',
      opt_evt_anniversary: 'Aniversario',
      opt_evt_other: 'Otra Celebración',
      ...
      step2_card5_title: 'Fotos e Imágenes',
      step2_card5_sub: 'No necesitas subirlas ahora — envíalas fácil al terminar.',
      lbl_photos_after_submit_title: 'Fotos: Envíalas al Terminar tu Pedido',
      lbl_photos_after_submit_desc: 'Para evitar límites de subida o perder lo que has escrito, completa y envía primero los datos de tu evento. ¡En la pantalla de confirmación tendrás un botón directo para enviar tus fotos por WhatsApp o Facebook!',
      lbl_cloud_link: 'O Comparte un Enlace de Álbum en la Nube (Opcional — Google Photos, iCloud, Drive)',
      hint_cloud_link: '¿Tienes tus fotos en Google Drive, Google Photos o iCloud? Puedes pegar el enlace aquí.',
      ...
      step3_sub: '¡Hemos recibido los datos de tu fiesta. Tu pedido está asegurado!',
      step3_badge_next: 'Siguiente Paso',
      step3_photos_action_title: 'Envíanos tus Fotos del Evento',
      step3_photos_action_desc: 'Ahora envíanos tus fotos favoritas (portada, corte de honor y galería) directamente por WhatsApp o Facebook para que nuestro equipo comience con el diseño:',
      btn_send_photos_wa_order: 'Enviar Fotos por WhatsApp (815) 242-7556',
      btn_send_photos_fb: 'O Enviar por Facebook',
      btn_send_photos_ig: 'O Enviar por Instagram',
