...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      'dresscode-ban-label': 'NO PALE PINK',
      'dresscode-reserved-label': 'RESERVED FOR THE QUINCEAÑERA',
      ...
      'message-quote': "I’m so grateful for all the love and guidance my family and friends have given me. Thank you for being here with me. I can’t wait to celebrate and party with all of you!",
    ...
    es: {
      ...
      'dresscode-ban-label': 'NO ROSA PÁLIDO',
      'dresscode-reserved-label': 'RESERVADO PARA LA QUINCEAÑERA',
      ...
      'message-quote': "Estoy muy agradecida por todo el amor y los consejos que mi familia y amigos me han dado. Gracias por estar aquí conmigo. ¡No puedo esperar para celebrar y festejar con todos ustedes!",
