...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      'registry-subtitle': 'MUESTRAS DE CARIÑO',
      'registry-desc': 'Su presencia y cariño son nuestro mejor regalo. Si desea tener un detalle con Genesis, <strong>cualquier regalo o detalle será recibido con profundo cariño y gratitud</strong>.',
    ...
    en: {
      ...
      'registry-subtitle': 'TOKENS OF AFFECTION',
      'registry-desc': 'Your presence and love are our greatest gift. If you wish to honor Genesis with a gift, <strong>anything is deeply appreciated and warmly welcomed</strong>.',
