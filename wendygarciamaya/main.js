...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      'registry-desc': 'Su presencia es nuestro mejor regalo. Si desea tener un detalle con Wendy, <strong>se dispondrá de un buzón para lluvia de sobres (efectivo)</strong>.',
    ...
    en: {
      ...
      'registry-desc': 'Your presence is our greatest gift. If you wish to honor Wendy with a gift, <strong>a wishing well box for envelope and cash gifts will be available</strong>.',
