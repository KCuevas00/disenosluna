...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      'program-reception-desc': 'OAK STUDIOS,<br />1437 OAK ST, LOS ANGELES, CA 90015',
      ...
      'padrinos-header': 'PADRINOS DE HONOR',
      ...
      'message-quote': 'Hay momentos en la vida que son inolvidables, y cumplir 16 años es uno de ellos. Por eso quiero celebrar este día tan especial rodeada de las personas que más quiero. Gracias a mi familia y a mis amigos por ser parte de mi vida!',
    ...
    en: {
      ...
      'padrinos-header': 'GODPARENTS OF HONOR',
